'''
Program Name: Playfair Cipher Encryption

Description:
This Python program implements the Playfair Cipher algorithm,
a classical encryption technique used in cryptography and
computer networks.

The Playfair Cipher encrypts plaintext in pairs of letters
(digraphs) using a 5x5 matrix generated from a keyword.
It replaces letters based on their positions in the matrix.

Concepts Used:
• Playfair Cipher Technique
• 5x5 Key Matrix Generation
• String Manipulation
• Encryption using digraphs

Working:
- Converts plaintext to uppercase and removes spaces
- Replaces 'J' with 'I'
- Generates 5x5 matrix using key
- Splits plaintext into letter pairs
- Applies rules:
